...
const Experience = () => {
    ...
    [
        ...
        { key: "fa2d", title: "FA2D", baseline: "Edition infos pour habillage live", desc: "Conception et développement Front-end / Back-end", technos:"Meteor.js & React.js", img: "https://s3.eu-central-1.amazonaws.com/testfa2d/images/logo_fa2d.png" },
        { key: "meetthebig", title: "Meet The Big", baseline: "Edition infos pour habillage live", desc: "Développement Front-end / Back-end, Mises à jour fonctionnalités", technos:"WordPress", img: "https://meetthebig.com/wp-content/uploads/2019/07/mtb-logo.png" },
        { key: "ndr", title: "Nuit Des Réseaux", baseline: "Edition infos pour habillage live", desc: "Développement Front-end / Back-end, Mises à jour fonctionnalités", technos:"WordPress", img: "https://nuit-des-reseaux.com/wp-content/uploads/2019/01/logo-NDR-general-blanc.png" },
    ]);

    return(
        <Box align="stretch" justify="center" direction="row-responsive" wrap="true" background={{"dark":false}}>
        {exps.map(exp => (
            <Box align="stretch" fil="horizontal" gap="xlarge" background={{"color":"#555555","position":"bottom"}} round="small" elevation="medium" margin="small" direction="column" animation={{"type":"fadeIn","size":"medium"}} justify="stretch" wrap={false} width="300px">
                <Box align="center" justify="center" pad="xsmall" margin="xsmall">
                    ...
                    <Heading level="3" size="medium" margin="xsmall" textAlign="center" color="light">
                        {exp.title}
                    </Heading>
